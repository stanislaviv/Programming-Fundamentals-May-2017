...
namespace _06.Stuck_Zipper_String
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			firstList = RemoveBiggerValues(minLenght, firstList);
			secondList = RemoveBiggerValues(minLenght, secondList);
		...
		private static List<int> RemoveBiggerValues(int minLenght, List<int> list)
		{
			int currentLenght = 0;
